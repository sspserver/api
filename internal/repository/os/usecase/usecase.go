...
import (
	...
	"github.com/sspserver/api/internal/repository/os/repository"
...
func (u *Usecase) Get(ctx context.Context, id uint64) (*models.OS, error) {
...
func (u *Usecase) FetchList(ctx context.Context, qops ...os.Option) ([]*models.OS, error) {
	if !acl.HaveAccessList(ctx, &models.OS{}) {
		return nil, errors.Wrap(acl.ErrNoPermissions, "fetch list")
	}
	return u.repo.FetchList(ctx, qops...)
}

func (u *Usecase) Count(ctx context.Context, qops ...os.Option) (int64, error) {
	if !acl.HaveAccessList(ctx, &models.OS{}) {
...
func (u *Usecase) Create(ctx context.Context, object *models.OS) (uint64, error) {
...
func (u *Usecase) Update(ctx context.Context, id uint64, object *models.OS) error {
