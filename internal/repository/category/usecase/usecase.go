...
import (
	...
	"github.com/sspserver/api/internal/repository/category/repository"
...
func (u *Usecase) Get(ctx context.Context, id uint64) (*models.Category, error) {
...
func (u *Usecase) FetchList(ctx context.Context, qops ...category.Option) ([]*models.Category, error) {
...
func (u *Usecase) Count(ctx context.Context, qops ...category.Option) (int64, error) {
	if !acl.HaveAccessList(ctx, &models.DeviceMaker{}) {
...
func (u *Usecase) Create(ctx context.Context, object *models.Category) (uint64, error) {
...
func (u *Usecase) Update(ctx context.Context, id uint64, object *models.Category) error {
