...
import (
	...
	"github.com/sspserver/api/internal/repository/adformat/repository"
	"github.com/sspserver/api/models"
)

type Usecase struct {
	repo adformat.Repository
}
...
func (u *Usecase) Get(ctx context.Context, id uint64) (*models.Format, error) {
...
func (u *Usecase) GetByCodename(ctx context.Context, codename string) (*models.Format, error) {
...
func (u *Usecase) FetchList(ctx context.Context, qops ...adformat.Option) ([]*models.Format, error) {
	if !acl.HaveAccessList(ctx, &models.Format{}) {
		return nil, errors.Wrap(acl.ErrNoPermissions, "fetch list")
	}
	return u.repo.FetchList(ctx, qops...)
}

func (u *Usecase) Count(ctx context.Context, qops ...adformat.Option) (int64, error) {
	if !acl.HaveAccessList(ctx, &models.Format{}) {
...
func (u *Usecase) Create(ctx context.Context, source *models.Format) (uint64, error) {
...
func (u *Usecase) Update(ctx context.Context, id uint64, source *models.Format) error {
...
func (u *Usecase) DeleteByCodename(ctx context.Context, codename string, msg *string) error {
	obj, err := u.repo.GetByCodename(ctx, codename)
	if err != nil {
		return err
	}
	...
	return u.repo.DeleteByCodename(ctx, codename)
}
