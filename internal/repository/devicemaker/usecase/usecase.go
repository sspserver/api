...
import (
	...
	"github.com/sspserver/api/internal/repository/devicemaker/repository"
	"github.com/sspserver/api/models"
)

type Usecase struct {
	repo devicemaker.Repository
}
...
func (u *Usecase) Get(ctx context.Context, id uint64) (*models.DeviceMaker, error) {
	obj, err := u.repo.Get(ctx, id, `Models`)
	if err != nil {
		return nil, err
	}
...
func (u *Usecase) GetByCodename(ctx context.Context, codename string) (*models.DeviceMaker, error) {
...
func (u *Usecase) FetchList(ctx context.Context, qops ...devicemaker.Option) ([]*models.DeviceMaker, error) {
	if !acl.HaveAccessList(ctx, &models.DeviceMaker{}) {
		return nil, errors.Wrap(acl.ErrNoPermissions, "fetch list")
	}
	return u.repo.FetchList(ctx, qops...)
}

func (u *Usecase) Count(ctx context.Context, qops ...devicemaker.Option) (int64, error) {
	if !acl.HaveAccessList(ctx, &models.DeviceMaker{}) {
...
func (u *Usecase) Create(ctx context.Context, object *models.DeviceMaker) (uint64, error) {
...
func (u *Usecase) Update(ctx context.Context, id uint64, object *models.DeviceMaker) error {
