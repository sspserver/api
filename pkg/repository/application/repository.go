...
type Repository interface {
	Get(ctx context.Context, id uint64) (*Application, error)
	FetchList(ctx context.Context, qops ...Option) ([]*Application, error)
	Count(ctx context.Context, qops ...Option) (int64, error)

	Create(ctx context.Context, source *Application) (uint64, error)
	Update(ctx context.Context, id uint64, source *Application) error
