...
func (r *mutationResolver) CreateOs(ctx context.Context, input models.OSCreateInput) (*models.OSPayload, error) {
	return r.os.Create(ctx, input)
}

// UpdateOs is the resolver for the updateOS field.
func (r *mutationResolver) UpdateOs(ctx context.Context, id uint64, input models.OSUpdateInput) (*models.OSPayload, error) {
...
func (r *queryResolver) ListOs(ctx context.Context, filter *models.OSListFilter, order []*models.OSListOrder, page *models1.Page) (*connectors.CollectionConnection[*models.Os], error) {
