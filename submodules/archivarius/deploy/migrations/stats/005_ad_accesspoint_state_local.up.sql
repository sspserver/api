CREATE TABLE IF NOT EXISTS stats.accesspoint_state_local (
   timemark           DateTime
 , datemark           Date
 , protocol           String
 , id                 UInt64      default 0
...
PRIMARY KEY (id, intHash32(id), protocol, datemark, timemark)
ORDER BY (id, intHash32(id), protocol, datemark, timemark)
